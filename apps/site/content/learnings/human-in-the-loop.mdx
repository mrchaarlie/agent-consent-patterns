...
- **Approval is where accountability is minted.** A recorded human decision converts "the agent did X" into "person P authorized X for reason R" — the raw material of [Auditability](/learnings/auditability/).
- **One-time consent decays.** An agent that runs for weeks under a consent granted in one moment is operating on stale authority; persistent, revocable consent keeps the delegation honest (Maler). See [Delegated Authority](/learnings/delegated-authority/).
