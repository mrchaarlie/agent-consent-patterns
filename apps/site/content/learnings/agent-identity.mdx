...
- **Keep personal contexts personal.** Direct, single-user interactions can stay on the user's own delegated identity — see [Delegated Authority](/learnings/delegated-authority/) for that model.
...
- An enterprise IdP registers each agent and applies [Cross App Access](/learnings/runtime-authorization/) so every app-to-app connection the agent makes is centrally visible and revocable (Okta).
